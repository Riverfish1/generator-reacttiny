...
var methods = {
  ...
  writing:function(){
    this.write(this.destinationPath()+path.sep+this.absoluteDevelopTestHtmlPath, this.developAppHtmlTemplate(this.developTestModelData));
    this.write(this.destinationPath()+path.sep+this.absoluteUnitTestPath, this.unitTestTemplate(this.developTestModelData));
    this.write(this.destinationPath()+path.sep+this.absoluteEndToEndTestHtmlPath, this.endToEndTestTemplate(this.developTestModelData));
